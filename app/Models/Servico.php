...
class Servico extends Model
{
    ...
    {
    	return $this->hasMany('App\Models\Historico')->orderBy('created_at','desc')->where('observacoes','like',"%@%")->where('observacoes','not like',"%alterado%")->where('observacoes','not like',"%Concluiu%");
    }
