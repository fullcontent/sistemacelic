    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <img src="{{public_path('img/logoCastro.png')}}" alt="" width="300">
      ...
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="empresa">
            ...
            <div class="col-xs-6 text-left" style="line-height: 10px;">
              ...
              <p style="margin-bottom: 20px; padding-top:20px;">Bal. Camboriú,
                {{ \Carbon\Carbon::parse($data)->isoFormat("D, MMMM, YYYY") }}
              </p>
        ...
        <div class="row">
          <div class="text-center">
            <h3>RECIBO</h3>
            <p style="padding: 20px; text-align:justify-all;">Recebemos da {{$empresa->razaoSocial}} a importância de R$
              {{number_format($totalReembolso, 2, '.', ',')}} referente ao pagamento de taxas para o processo de
              legalização, conforme demonstrativo comprovante em anexo.
            </p>
          </div>
