                                        ...
                                        <div class="btn-group">
                                            @if($e->status == 'CONCLUIDA' || $e->status == 'concluido' || $e->status == 'emitida')
                                                <a href="{{ route('nfse.download.pdf', $e->id) }}" class="btn btn-default btn-xs"
                                                    target="_blank" title="Ver PDF" @if(empty($e->pdf_url)) disabled style="opacity:0.5" @endif><i class="fa fa-file-pdf"></i></a>
                                                <a href="{{ route('nfse.download.xml', $e->id) }}" class="btn btn-default btn-xs"
                                                    target="_blank" title="Ver XML" @if(empty($e->xml_url)) disabled style="opacity:0.5" @endif><i class="fa fa-code"></i></a>
