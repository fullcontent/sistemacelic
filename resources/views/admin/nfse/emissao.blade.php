    ...
    <div class="col-md-12">
                    ...
                    @if(strpos(session('error'), 'Resposta:') !== false)
                        ...
                        if ($decoded) {
                            ...
                            $formattedJson = $jsonMsg;
                                ...
                                <pre
                                    style="background: rgba(0,0,0,0.1); color: #fff; border: 1px solid rgba(255,255,255,0.2); margin-top: 10px; max-height: 300px; overflow-y: auto;">{{ $formattedJson }}</pre>
                    @else
                        {{ session('error') }}
                    @endif
                </div>
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Faturamento #{{ $faturamento->id }} - {{ $faturamento->empresa->nomeFantasia }}
                </h3>
            </div>
            ...
            <form id="formEmissao" action="{{ route('nfse.processar', $faturamento->id) }}" method="POST">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="info-box bg-aqua option-card" data-option="1"
                        ...
                        <div class="col-md-6">
                            <div class="info-box bg-green option-card" data-option="2"
                                style="cursor: pointer; opacity: 0.7;">
                        ...
                        <div class="col-md-6">
                            <div class="info-box bg-purple option-card" data-option="3"
                                style="cursor: pointer; opacity: 0.7;">
                        ...
                        <div class="col-md-6">
                            <div class="info-box bg-orange option-card" data-option="4"
                                style="cursor: pointer; opacity: 0.7;">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($faturamento->servicosFaturados as $item)
                                        @if($item->detalhes)
                                            <tr>
                                                <td><input type="checkbox" name="servico_ids[]" value="{{ $item->servico_id }}"
                                    ...
                                    <input type="hidden" name="nova_empresa" id="input_nova_empresa" value="1">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="override_cnpj" id="override_cnpj"
                                                            class="form-control" placeholder="00.000.000/0000-00">
                                                        <span class="input-group-btn">
                                                            <button type="button" class="btn btn-info btn-flat"
                                                                id="btnConsutarCnpj"><i class="fa fa-search"></i>
                                                                Consultar</button>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="override_razaoSocial"
                                                        id="override_razaoSocial" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>E-mail:</label>
                                                    <input type="text" name="override_email" id="override_email"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="override_logradouro"
                                                        id="override_logradouro" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Número:</label>
                                                    <input type="text" name="override_numero" id="override_numero"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Bairro:</label>
                                                    <input type="text" name="override_bairro" id="override_bairro"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>CEP:</label>
                                                    <input type="text" name="override_cep" id="override_cep"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Cidade:</label>
                                                    <input type="text" name="override_municipio" id="override_municipio"
                                                        class="form-control">
                                                    <input type="hidden" name="override_codigoCidade"
                                                        id="override_codigoCidade">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>UF:</label>
                                                    <input type="text" name="override_uf" id="override_uf"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="box-footer">
                        <a href="{{ route('faturamento.show', $faturamento->id) }}"
