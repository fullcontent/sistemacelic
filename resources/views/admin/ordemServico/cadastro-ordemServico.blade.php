...
<div class="row">
    <div class="col-md-12">
        <h2 class="page-header-title">Nova Ordem de Serviço</h2>
    </div>
</div>
...
<div class="row">
	...
	@include('admin.ordemServico.form-ordemServico')
                ...
                <button type="submit" class="btn btn-primary" style="padding: 8px 25px;"><i class="fa fa-save"></i> Salvar Ordem de Serviço</button>
              	</div>
