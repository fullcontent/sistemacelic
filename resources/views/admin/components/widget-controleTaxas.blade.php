            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin" id="servicos">
                  ...
                  <tbody>
                    @foreach($servicos->where('tipo','controleTaxas')->where('situacao','!=','arquivado') as $servico)
                  <tr>
...
"></i></a></td>
            ...
            <div class="box-footer clearfix">
              <a href="{{route('servicos.create', ['id'=>$dados->id,'t'=>substr($route, 0,7),'tipoServico'=>'controleTaxas'])}}" class="btn btn-sm btn-info btn-flat pull-left"><span class="glyphicon glyphicon-plus-sign"></span> Novo Serviço</a>
