<div class="box box-success  collapsed-box">
            <div class="box-header with-border">
              <a href="#" data-widget="collapse"><h3 class="box-title">Controle de Certidões</h3></a>
...
"></i></a></td>
            ...
            <div class="box-footer clearfix">
              <a href="{{route('servicos.create', ['id'=>$dados->id,'t'=>substr($route, 0,7),'tipoServico'=>'controleCertidoes'])}}" class="btn btn-sm btn-info btn-flat pull-left"><span class="glyphicon glyphicon-plus-sign"></span> Novo Serviço</a>
