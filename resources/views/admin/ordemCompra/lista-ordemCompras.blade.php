            ...
            <tbody>
                @foreach($ordensCompra as $oc)
                    <tr>
                        ...
                        <td>{{optional($oc->prestador)->nome ?? 'N/A'}}</td>
                        <td>{{optional($oc->servicoPrincipal)->os ?? 'N/A'}} |
                            {{optional($oc->servicoPrincipal)->nome ?? 'Serviço não vinculado'}}</td>
                        <td>{{$oc->escopo}}</td>
                        ...
                        <td class="text-center">
                            ...
                            @if(count($oc->rating))
                                ...
                                <p><a href="#" class="btn btn-xs btn-default" data-target="#modal-avaliacoes" data-toggle="modal"
                                        id="rates-show" data-ordemcompra="{{$oc->id}}" data-prestador_id="{{$oc->prestador_id}}">ver
                                        avaliações ({{$oc->rating->count()}})</a></p>
                            @else
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- O botão abaixo estava incorretamente usando $oc fora do loop --}}
