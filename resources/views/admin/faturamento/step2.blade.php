			...
			<div class="col-md-12">
				...
				<div class="box-body">
					<div class="col-md-12">
						...
						<p><b>Empresa(s): </b>
						<ul style="column-count: 3; column-gap: 20px; list-style-position: inside; padding-left: 0;">
						...
						@if(isset($servicosFaturar->servicoFinalizado))
							@foreach($servicosFaturar->sortBy('servicoFinalizado.finalizado') as $value => $s)
								<tr>
									...
									<td>@php echo App\Http\Controllers\FaturamentoController::formatCnpjCpf($s->unidade->cnpj); @endphp
									</td>
									<td>{{$s->nome}}</td>
									<td>
