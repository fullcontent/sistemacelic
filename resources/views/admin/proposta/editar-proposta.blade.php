            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-success adicionar" type="button"><i class="glyphicon glyphicon-plus"></i>
                            Adicionar</button>
                        <button class="btn btn-info btn-xs adicionarSub" type="button"><i
                                class="glyphicon glyphicon-plus"></i> SubServiço</button>
                    </div>
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            <div class="col-xs-12">
                ...
                <p><b>Endereço: </b><span>{{$proposta->unidade->endereco}},{{$proposta->unidade->numero}} -
                        {{$proposta->unidade->bairro}} {{$proposta->unidade->cidade}}/{{$proposta->unidade->uf}}</span></p>
            </div>
                            ...
                            <tr id="{{$index}}">
                                ...
                                <td>
                                    <p>
                                        <b>{{$s->servico}}</b>
                                        @if($s->servicoCriado)
                                            <a href="{{route('servicos.show', $s->servicoCriado->id)}}"
                                                class="btn btn-xs btn-success no-print">{{$s->servicoCriado->os}}</a>
                                        @endif
                                    </p>
                                    <p>{{$s->escopo}}</p>
                                </td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-xs btn-danger remove no-print" type="button" data-id="{{$s->id}}"
                                        data-servicoID="{{$s->servicoCriado->id ?? ''}}" data-index="{{$index}}"><i
                                            class="glyphicon glyphicon-remove"></i></button>
                                    <button class="btn btn-xs btn-info edit no-print" type="button"
                                        data-servico="{{$s->servico}}" data-escopo="{{$s->escopo}}" data-valor="{{$s->valor}}"
                                        data-id="{{$s->id}}" data-toggle="modal" data-target="#editar-servico"><i
        ...
        <div class="row documentos">
            ...
            <footer>
                <div class="col-xs-12">
                    <h2 class="text-center">
                        <img src="{{asset('img/footerCastro.png')}}" class="img-responsive">
                    </h2>
                </div>
            </footer>
...
@section('js')
    ...
    <script src="https://cdn.tiny.cloud/1/mdbybl5sde5aiobm264wk5r9q3cua6n3r2z6hvc7aag1ry65/tinymce/5/tinymce.min.js"
