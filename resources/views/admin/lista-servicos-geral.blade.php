        ...
        <table id="example" class="display" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th>O.S.</th>
                    <th>Data Final</th>
                    <th>Data Limite Ciclo</th>
                    <th>Situação</th>
                    <th>NF</th>
                    <th>Observações</th>
                    <th>Escopo</th>
                    <th>Nº do laudo de exigências</th>
                    <th>Data de emissão do laudo de exigências</th>
                    <th>Link do laudo</th>
                    <th>Nº do Protocolo</th>
                    <th>Emissão Protocolo</th>
                    <th>Link do Protocolo</th>
                    <th>Link do documento/alvará</th>
                    <th>Responsável</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            // A linha para desabilitar o erro, caso você ainda queira.
            // Mas com os scripts na ordem correta, ela não é necessária.
