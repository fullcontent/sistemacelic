...
@section('title', 'Cadastrar pendência')
...
<div class="row" style="margin-bottom: 15px;">
	<div class="col-sm-12">
		<h1 style="margin: 0; font-weight: 700; color: #333;">Cadastrar Pendência</h1>
	</div>
</div>
@stop
...
<div class="form-container">
	...
	<div style="border-top: 1px solid #f4f4f4; padding-top: 20px; margin-top: 20px; display: flex; gap: 10px;">
		<a href="{{route('servicos.show', $servico_id)}}" class="btn btn-default btn-pill">Voltar</a>
